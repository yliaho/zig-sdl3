...
/// ## Remarks
/// The key is the base SDL_Keycode generated by pressing the scancode using the current keyboard
/// layout, applying any options specified in SDL_HINT_KEYCODE_OPTIONS. You can get the SDL_Keycode
